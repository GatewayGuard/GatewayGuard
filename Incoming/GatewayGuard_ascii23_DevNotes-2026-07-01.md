...
**Reference:** See `GatewayGuard_SystemBaseline_Diagnostic.ps1` for working code.
...
## PENDING — RESULTS FROM ascii22 DELL RUN (30-Jun-2026)
- Full scan results to be logged here after offline scan completes and machine reboots
- Note: Offline scan initiated during first Pro test run — currently running (blue screen)
