...
function Enable-SleepPrevention {
    try {
        ...
        # BUGFIX ascii23 (2026-07-04): -bor on uint32 values can silently
        # produce a signed int32 result in PowerShell 5.1 (e.g. -2147483648
        # instead of 2147483648), which then fails to convert back to uint32
        # for the P/Invoke call. Explicitly re-cast the COMBINED result.
