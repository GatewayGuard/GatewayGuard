...
└── tips.html               (Helpful Windows 11 Tips)
```
...
### HELPFUL WINDOWS 11 TIPS (tips.html)

**Purpose:** Plain-English how-to guides for everyday Windows 11 tasks.
Builds traffic, builds trust, gives users a reason to return.
Not security-specific -- general Windows helpfulness.

**URL:** gatewayguard.co/tips

**Format:** One tip per section, expandable over time. Each tip follows
the same structure:
1. What it does (one sentence)
2. Which method is right for you (comparison if multiple options)
3. Step-by-step instructions
4. Where your file ends up / what to expect

**Tips planned:**

| # | Title | Source | Status |
|---|-------|--------|--------|
| 1 | How to Capture Streaming Audio on Windows 11 | Capture_Streaming_Audio_Windows11.pdf | Ready to format |

**Design notes:**
- Same black and white aesthetic as rest of site
- Each tip self-contained -- users can link directly to a tip
- Phase 3 build -- not a launch dependency
...
10. tips.html (Helpful Windows 11 Tips -- first tip: streaming audio capture)
11. Blog/changelog page
...
**Navigation:**
- Simple top nav: Home | Download | Guide | Tips | Beta | Compatible
...
1. ~~Get domain DNS pointed to hosting~~ -- gatewayguard.co registered at Namecheap
2. ~~Choose hosting~~ -- GitHub Pages (free) confirmed; point Namecheap DNS to GitHub
3. Set up GitHub account and Pages repository
4. Build Phase 1 pages (guide + download + home)
5. Add screenshots as each setting page is built
6. Launch with Phase 1, build Phase 2 after beta tester program starts
7. Phase 3: add tips.html starting with streaming audio capture tip
