...
<!-- Document Name: website-copy -->
<!-- Moved here from .claude/rules/ on 2026-08-09 so Claude Cloud can see it.
     .claude is a dot-folder and may not be selectable in the connector
     picker; WebSite/ is in connector scope. A path-triggered pointer
     remains at .claude/rules/website-copy.md so Claude Code still
     auto-loads on website work. One copy of the rule, one pointer. -->
