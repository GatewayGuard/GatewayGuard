...
**TEST ON THE DELL FIRST (added 2026-08-02).** CGDELL carries Defender,
BitLocker, TPM, Secure Boot **off**, and a **trial-expired**
Malwarebytes -- most claims about this project's subject matter can be
settled there in seconds. Prefer running the check over asking Bill to
run it: asking costs a round trip and his time, running costs seconds.
Say plainly when something cannot be tested on any available machine.
