# Dated: 2026-07-17 09:00 ET
# ================================================================
# FILE:    W11-SecurityHardening-v3-ascii32-2026-07-17.ps1
# BUILD:   ascii32  |  Version 3.1
        ...
        switch ($userInput.ToUpper()) {
            ...
            "R" {
                ...
                if ($blSetting -and $blSetting.Selected) {
                    ...
                    Write-Host ""
                    Pause-ForUser "  Press Enter or Space to continue to the next step..."
