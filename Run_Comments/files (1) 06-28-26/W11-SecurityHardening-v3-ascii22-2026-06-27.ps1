# ================================================================
# FILE:    W11-SecurityHardening-v3-ascii22.ps1
# BUILD:   ascii22  |  Version 3.0
...
function Show-PreScanGate {
    ...
    if ($global:IsFirstRun) {
        Draw-Box -Color White -Lines @(
            ...
            "     WHAT TO LOOK FOR: Any items found will show as Threats   ",
            "     detected. Click each one to see what was found and where.",
            "     Items marked Remediated were automatically handled.      ",
            "     Items marked Action needed require your decision.        ",
            "  Guide: Phase 1, Step 2                                     ",
            "                                                             ",
            "  STEP 2 OF 2: MANUAL MALWAREBYTES FREE SCAN (RECOMMENDED) ",
            "  Malwarebytes Free catches PUPs and adware that Defender   ",
            "  sometimes misses -- things that slow your PC, show ads,   ",
            "  and can open security holes. Skipping this means these    ",
            "  items stay undetected. Takes 5-10 min and is worth doing. ",
