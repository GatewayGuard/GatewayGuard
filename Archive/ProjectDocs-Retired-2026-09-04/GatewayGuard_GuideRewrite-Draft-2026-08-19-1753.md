...
- **Change History Log:**
  ...
  - 2026-08-19 17:53: **Self-review, five defects fixed.** (1) The gate said "first" and appeared fourth — moved to immediately after the cover. (2) **No Table of Contents existed at all** — added, with the instruction to replace it with a Word field. (3) "Phase 5 — Two settings most guides miss" was an unverifiable claim about competitors in a heading (PL-4) — now "Two more settings worth changing". (4) Phases 4 and 5 were leftover buckets — merged into "Phase 4 — Privacy and housekeeping". (5) Marketing plan trust ladder written in, filed separately.
  - 2026-08-19 09:50: Front help section replaced with a four-line gate per Bill. The other 33 lines moved to a *Getting help* addendum at the back, ransomware first. **Four stale pointers to the old section name corrected** — lines 141 and 148 named in Claude Code's review, plus two more it did not find, at the unfamiliar-account warning and the Phase 3 gate.
  - 2026-08-15 18:38: Reconciled against `WebSite/html/` and `ProjectDocs/GatewayGuard_WebsiteSourcePack-2026-08-15-1751.md` under RULE W-07. Twelve corrections applied — see RECONCILIATION below.
...
> **Work or university computer?** Do not use this guide — contact your IT
> department.
>
> **Missing money, someone can see your screen, or files that will not
> open?** Click this link — *Getting help* (page 00)
>
> Everyone else, begin at Step 1.

*[FORMATTING: set this block in the `GateBox` style — body size + 2 pt,
bold, space above and below, no border rule. Renders at 16 pt in the
Standard 14 pt edition and stays two points above body in all five.
Page number must be a Word cross-reference field, never typed.]*

---

## Contents

*[FORMATTING: replace this list with a Word Table of Contents field —
References › Table of Contents › Automatic Table. Update the field before
every export. Do not type page numbers.]*

| | Page |
|---|---|
| Two things first | 00 |
| What this guide is | 00 |
| Before you start | 00 |
| Quick-reference table — all 19 settings | 00 |
| **Phase 1 — The basics** | 00 |
| Step 1 — Windows Update | 00 |
| Step 2 — Windows Security | 00 |
| Step 3 — BitLocker Data Encryption | 00 |
| Step 4 — Your account and sign-in | 00 |
| **Phase 2 — Programs and browsers** | 00 |
| Step 5 — Look at what is installed | 00 |
| Step 6 — Your browsers | 00 |
| **Phase 3 — If you found something harmful** | 00 |
| **Phase 4 — Privacy and housekeeping** | 00 |
| Going forward | 00 |
| If something looks suspicious — quick answers | 00 |
| **Getting help** | 00 |
| Advanced — optional | 00 |
| Firefox | 00 |
| Words you may meet | 00 |
...
back of this guide (page 00). Nothing on that list needs to be dealt with
today.
...
cause problems. Take the name to *Getting help* at the back (page 00).
...
- Anything in *Getting help* at the back applies to you
...
## Two more settings worth changing
...
**Most of this guide is routine. A few situations are not, and this section
covers them.**

## If your files will not open and something is demanding payment

**Do not pay, and do not restart the computer.** Restarting can destroy the
one thing that sometimes allows files to be recovered.

This is ransomware, and it needs someone with hands on the machine today.
Take the computer to a local repair shop, or call someone who can come to
you. Do not use this guide first.

## If money is missing from an account

**Call the bank before anything else**, using the number printed on your
card — not a number from an email, a search result, or a phone call you
received.

Fraud is time-sensitive in a way that computer settings are not. Come back
to this guide afterwards.

## If someone can see your screen

If a former partner, or anyone you are afraid of, may be watching this
computer, **the changes in this guide can be noticed by them** — and being
noticed is the danger, not the setting.

Use a different device — a friend's phone, or a computer at a library —
and speak to someone who handles this before changing anything here.

- **The National Domestic Violence Hotline** — thehotline.org
- **The Coalition Against Stalkerware** — guidance written for exactly this
  situation

## If someone else is in your email

If messages you did not write have been sent from your account, or a
sign-in appears from a place you have never been, **that is happening now
rather than in the past.**

Change that password from a different device, and turn on two-step
verification. Then work through Phase 3 of this guide, which covers what
else to check.

## If this is a work or university computer

**Contact your IT department and do not use this guide.** They own these
settings, they have their own procedures, and on a managed computer a
change made without them can cause problems that are not yours to fix.

## Who counts as help

A relative or friend who is comfortable with computers. A local repair shop
with a physical address and reviews you can read. Your internet provider's
support line for anything to do with the connection itself.

## Be careful who you call

**If a pop-up, a phone call, or an email tells you your computer is
infected and gives you a number, that is the scam itself.**

Real security warnings never ask you to phone anyone. Nobody legitimate
will contact you out of the blue asking to connect to your computer.
