<!-- Dated: 2026-09-02 15:53 ET -->
<!-- Editor: Claude Code (CGDELL) -->
# GatewayGuard LLC - Product License Agreement (v3.0) - working draft

**This draft is written in Markdown, not generated from a `.docx`.** v2.4 carried
the note *"This file is generated. Edit the .docx master, then regenerate."*
**That is deliberately reversed for v3.0**, because the `.docx` master could not
be opened on 2026-08-25 and the licence had to be reconstructed from its readable
twin. **This file is the source until the two open decisions land**; the `.docx`
is rebuilt from it afterwards, not before.

**Two DECISION NEEDED markers block finalisation** -- the Guide's print sizes
(Section 1 and Section 5) and the bundle refund (Section 9). **Both are drafted
in full, both ways, so Bill picks a paragraph rather than writing one.**

---

GATEWAYGUARD LLC — PRODUCT LICENSE AGREEMENT

Version 3.0 — Applies Bill's Consult A answers of September 2, 2026
...
Supersedes GatewayGuard_License-2026-08-25-1400 (v2.4). Draft — attorney review required before use. This document is not legal advice.

---

## Changes Since Version 2.4

This version applies Bill's written answers to Consult A, dated September 2, 2026, and the guidance Gumroad support gave the same week on how to describe their role. Items still open are marked DECISION NEEDED.

**1. The refund policy is now different for each product.** Version 2.4 gave both products one unconditional 30-day window. Section 9 now gives **Checkup a 14-day full refund with no reason required**, and **sells the Guide without a refund**. Bill's answer to A1: *"14 day refund ... for checkup and no refund for security guide."* The Guide clause carries its own reason — every setting the Guide covers is published free on the website, so a buyer can read the whole scope before deciding.

**2. The log-file requirement is gone.** Bill's answer to A2 was *"Remove this."* No refund anywhere in this agreement requires the customer to produce a diagnostic file, prove anything, or let us attempt a repair first.

**3. The two billing exceptions are gone, and not because they stopped being true.** Version 2.0 listed a double charge and a missing download as named refund exceptions. Both are Gumroad's to resolve, and Bill's instruction of September 2 is the reason they are not merely reworded here: *"they won't know they were double charged by gumroad until after the fact, the receipt will tell us how to handle this. The last thing the buyer will think to do is go back and read the EULA."* **A licence is not a support document.** That routing belongs in the receipt and on the support page, and it is recorded as a separate task rather than buried here.

**4. Gumroad's role is now stated plainly, in a section of its own.** New Section 10. Bill's answer to A3 accepted that Gumroad's policy governs the outcome of a Gumroad sale — *"This is true"* — and asked Gumroad how to describe it. Their answer, quoted in the consult file, asks for two things: that we state the customer receives a licence and not ownership with title remaining ours, and that we name Gumroad, Inc. as merchant of record handling purchase, payment, receipt and tax. Both are now in the agreement, with a pointer to gumroad.com/terms.

**5. How the buyer accepts this agreement is answered.** Version 2.4's appendix recorded the problem in plain terms — *"Nothing shows this agreement to the buyer, and nobody accepts it"* — and called it the first question for the attorney. ***sourced, Gumroad Help Center:*** custom checkout fields support terms acceptance, where the seller enters *"the URL for your terms that customers must accept before purchasing,"* and that field *"is always set to Required."* Bill's answer to A6 matches: *"our eula license will be accepted by purchaser during payment processing handled by gumroad."* **This carries a requirement — see the appendix. The agreement must be a public web page before the store opens.**

**6. Everything else is carried forward unchanged.** PC binding, the source-readable clause, the warranties as softened in v2.4, the programs review, the annual Windows update disclosure, the terms-change mechanism and severability all stand as written, with their existing DECISION NEEDED markers intact.

---

## License Agreement

This agreement is between you (“you”) and GatewayGuard LLC, a Maine limited liability company (“GatewayGuard,” “we,” or “us”). By buying, downloading, installing, or running any GatewayGuard product, you agree to these terms. If you do not agree, do not use the product.

**What you are buying.** In every case you are buying a licence to use a GatewayGuard product. You are not buying the product itself. GatewayGuard LLC keeps ownership of everything it makes — the code, the text, the design, and every right not given to you in this agreement.
...
The Guide: the GatewayGuard Windows Security Walkthrough Guide, supplied as a PDF document in five print sizes with identical wording. Covered in Section 5.
...
>
> **Option B — the bundle is not refundable.** *(consistent with the Guide, but the software then carries no guarantee on the route we most want people to take)*
>
> > **Checkup and the Guide bought together.** A bundle includes the Guide, which is sold without a refund. For that reason a bundle purchase is not refundable. If you want Checkup with its 14-day refund, buy it on its own.
>
> **There is no third option that closes the gap.** Under Option A the bundle becomes the refundable route to a non-refundable Guide. Under Option B the software loses its guarantee whenever it is bought in a bundle. Refunding only "the Checkup part" of a bundle means computing its discounted share and explaining that arithmetic to a customer by email, which costs more than the sale. **Both options are honest; neither is tidy. This one is a business judgement, not a drafting problem.**

**How to ask for a refund.** Email support@gatewayguard.co from the address you bought with, or use the refund link in your Gumroad receipt. Give us your order number. We aim to answer within two business days.

**What happens when we refund you.** Your license ends and you should delete the copies you have, including any backup. We are aware we cannot check this, and we are not going to try. We are asking you to be straight with us, in the same way we are being straight with you.

**Gumroad may decide differently, and may do so in your favour.** We sell through Gumroad, and Gumroad — not us — takes your payment and handles refunds and disputes. Gumroad operates its own refund policy and reserves the right to refund a purchase at its own discretion for up to 90 days, including a purchase this agreement describes as non-refundable. We are telling you this because it is true and you should know it, not because we are inviting you to test it. Nothing in this agreement takes away any right you have under the consumer law where you live.

### 10. How You Bought This, and Who Handled the Payment

**We sell our products through Gumroad, and this section explains who does what.** It matters because the company that took your money is not the company that made the product.

**What we do.** GatewayGuard LLC makes Checkup and the Guide, owns them, and licenses them to you under this agreement. Title and every right in the products stay with us. What you receive is permission to use them on the terms set out above — not ownership of them.

**What Gumroad does.** Gumroad, Inc. acts as the merchant of record for the sale and sells the product through its platform. That means Gumroad is the party you pay and transact with. Gumroad processes the payment, issues your receipt, collects and remits any sales tax or VAT that applies where you live, and handles refunds and chargebacks.

**Gumroad's own terms apply to the payment side of your purchase**, and you can read them at https://gumroad.com/terms. Those terms cover the transaction. This agreement covers the product.

**Where the two meet.** Where Gumroad's terms govern how a payment or a refund is handled, Gumroad's terms decide the outcome. This agreement decides what you may do with the product itself.

**If we ever sell to you directly** rather than through Gumroad, the paragraphs above about Gumroad do not apply to that purchase, and we will be the party you pay.

> **DECISION NEEDED — this section is new and unreviewed.** It is drafted from written guidance Gumroad support gave Bill in the week of September 2, 2026, quoted in full in `GatewayGuard_AttorneyQuestions-WithBillAnswers-2026-09-02-1545.md`. **That guidance is Gumroad describing Gumroad's own position, and it is not legal advice.** Two points for the attorney: whether naming Gumroad as merchant of record and pointing at their terms creates any exposure for us, and whether referencing a third party's terms by link — terms that can change without notice and that neither we nor the buyer control — is acceptable in a consumer agreement.
...
> **DECISION NEEDED — the terms-change clause is new and unreviewed.** *(carried forward from v2.4, unchanged)* Question 11 of the August 4 cover note listed “a mechanism for changing terms in future versions” and the consult notes record only severability as answered. This clause is drafted from scratch. It is deliberately narrow: a change applies only to a later purchase, never to one already made. Confirm or replace.

### 14. If Part of This Agreement Cannot Be Enforced
...
GatewayGuard_License-2026-09-02-1553  |  Dated: 2026-09-02 15:53 ET  |  Version 3.0  |  Last editor: Claude Code (CGDELL)
