...
- **26 lines per screen maximum, and every screen ends with a blank line.**
  ...
  52 -- **cleared 2026-09-26 in ascii45: 52 (B1), 73, 26, 27 (B2b-1), 41 (B2b-2)**, so five remain) and sit in a named baseline inside the checker — reported on every run,
