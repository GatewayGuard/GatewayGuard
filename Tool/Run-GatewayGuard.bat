@echo off
REM Dated: 2026-07-27 16:55 EDT
REM File: Run-GatewayGuard.bat (always-current launcher -- paired build below)
REM CURRENT BUILD: W11-SecurityHardening-v3-ascii36-2026-07-27-1655.ps1
REM
...
REM
cd /d "%~dp0"
powershell.exe -NoProfile -ExecutionPolicy Bypass -File "W11-SecurityHardening-v3-ascii36-2026-07-27-1655.ps1"
