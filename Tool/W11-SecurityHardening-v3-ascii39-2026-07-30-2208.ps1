    ...
    try {
        ...
        for ($ggI = $ggNew - 1; $ggI -ge 0; $ggI--) {
            try {
                ...
                Write-Log -Message ("SILENT ERROR at " + $Where + ": " + $ggMsg + $(if ($ggAt) { " | " + $ggAt } else { "" })) -Status "ERROR"
            } catch {}
        }
    } catch {}
}
...
function Show-BitLockerHomeScreen {
    ...
    Write-Host ""
    Pause-ForUser "  Press Enter or Space to see whether this PC can use it..."
    ...
    Draw-Box -ScreenId "81" -Color White -Lines @(
        ...
        "  2. Press Enter and look at the switch                     ",
        "     It should say On. If it does not, turn it on.          ",
        "                                                            ",
        ...
        "                                                            ",
        "  DO YOU NEED TO REBOOT? No. DO YOU NEED TO QUIT CHECKUP?   ",
        "  No. Encryption runs in the background and you can keep    ",
        "  using the PC. It can take an hour or more on a large      ",
        "  drive -- that is normal.                                  ",
        "                                                            ",
