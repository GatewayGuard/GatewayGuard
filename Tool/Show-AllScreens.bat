@echo off
REM Dated: 2026-08-15 09:12 EDT
REM File: Show-AllScreens.bat (always-current gallery launcher)
REM CURRENT BUILD: W11-SecurityHardening-v3-ascii40-2026-08-15-0828.ps1
REM
...
REM
cd /d "%~dp0"
powershell.exe -NoProfile -ExecutionPolicy Bypass -File "W11-SecurityHardening-v3-ascii40-2026-08-15-0828.ps1" -Gallery
