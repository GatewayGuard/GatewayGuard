...
REM CURRENT BUILD: W11-SecurityHardening-v3-ascii42-2026-08-19-1830.ps1
REM
...
REM
cd /d "%~dp0"
powershell.exe -NoProfile -ExecutionPolicy Bypass -File "W11-SecurityHardening-v3-ascii42-2026-08-19-1830.ps1" -Gallery
