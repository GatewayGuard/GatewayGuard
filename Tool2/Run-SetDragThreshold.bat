...
echo.
echo  ==============================================================
echo   SET the mouse drag threshold (stop accidental folder moves)
echo  ==============================================================
echo.
net session >nul 2>&1
if %errorlevel%==0 (
...
echo.
powershell.exe -NoProfile -ExecutionPolicy Bypass -File "%~dp0Set-DragThreshold-2026-08-31-0943.ps1"
echo.
