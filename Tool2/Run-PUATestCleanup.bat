...
REM File: Run-PUATestCleanup.bat
REM
REM  Removes the PUA test folders and the Defender exclusion, and reads
REM  both back to prove they are gone.
REM
...
set "GGPS1=Remove-PUATestFolder-2026-09-07.ps1"
...
if errorlevel 1 (
  ...
  echo   Run-PUATestCleanup.bat and choose 'Run as administrator'.
  echo.
  echo   Press Enter to close this window.
  set /p "GGCLOSE="
  exit /b 1
